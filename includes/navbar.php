<header class="header" data-header>
    <div class="container">
      ...
      <img src="assets/logo.jpeg" width="136" height="46" alt="Blessed to bless healthcare">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <div class="navbar-top">
          ...
          <a href="#" class="logo">
            <img src="./assets/images/logo.svg" width="136" height="46" alt="Blessed to bless healthcare">
          </a>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="#doctors" class="navbar-link title-md">Doctors</a>
          </li>
